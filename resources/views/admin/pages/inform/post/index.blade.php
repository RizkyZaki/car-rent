          ...
          <div class="nk-block-head">
            <div class="nk-block-head nk-block-head-sm">
              <div class="nk-block-between">
                ...
                <div class="nk-block-head-content">
                  <a href="{{ url('dashboard/inform/post-car/create') }}" class="btn btn-primary"><em
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <ul class="link-list-opt no-bdr">
                                  <li><a href="{{ url('dashboard/inform/post-car/' . $item->slug . '/edit') }}"><em
                                        class="icon ni ni-pen"></em><span>Edit</span></a>
                                  </li>
                                  <li><a href="javascript:void(0);" data-id={{ $item->id }} class="create"><em
                                        class="icon ni ni-plus"></em><span>Tambah Sewa</span></a></li>
                                  <li><a href="{{ url('dashboard/inform/rent/' . $item->slug) }}"><em
                                        class="icon ni ni-info"></em><span>Daftar Sewa</span></a></li>
                                  <li><a href="javascript:void(0);" data-url="inform/post-car"
