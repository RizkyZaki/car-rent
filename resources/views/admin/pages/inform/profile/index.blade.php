...
@section('content-admin')
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <ul class="link-list-opt no-bdr">
                                  <li><a href="javascript:void(0);" data-slug={{ $item->slug }} class="update"><em
                                        class="icon ni ni-pen"></em><span>Edit</span></a></li>
                                  <li><a href="javascript:void(0);" data-url="inform/profile"
                                      data-identity={{ $item->slug }} class="delete"><em
        ...
        <div class="modal-body">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" onkeyup="createTextSlug()" id="name" name="name"
                placeholder="Name">
            </div>
            <div class="form-group col-md-6">
  ...
  @push('customJs')
    ...
    <script src="{{ asset('custom/js/inform/profile.js') }}"></script>
  @endpush
@endsection
